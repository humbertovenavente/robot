...
- Usage: Reference from command with `@/Users/humbertovenavente/CascadeProjects/windsurf-project/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/humbertovenavente/CascadeProjects/windsurf-project/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/humbertovenavente/CascadeProjects/windsurf-project/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
