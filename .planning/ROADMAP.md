...
- [ ] 02-02-orchestrator-server-PLAN.md — orchestrator.py FastAPI app: /ws multiplexed by role, in-memory registry, broadcast, GET /api/stations (ORC-01..04)
- [ ] 02-03-station-ws-client-PLAN.md — ws_client.py background-thread client with 1→8s reconnect backoff; wire into run_station via status_listener (ORC-01, ORC-02, ORC-04)
...
| 2. Orchestrator + Dashboard | 0/5 | Not started | - |
